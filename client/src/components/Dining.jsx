        ...
        <div ref={horizonRef} id='horizon-hotel' data-aos='fade-up'>
          <div id='horizon-hotel-words' data-aos='fade-right'>
            ...
            <p>
              ...
              urban bar with panoramic views of the Nairobi skyline. With floor
              to ceiling viewing screens, stylish mixology from the long bar,
              tapas and dishes to share, both indoors and out on the terrace, it
              is a venue is designed for good times and great vibes
            </p>
        ...
        <div ref={cascadeRef} id='glow-hotel' data-aos='fade-up'>
          ...
          <div id='glow-hotel-words' data-aos='fade-left'>
            ...
            <p>
              ...
              catch up with friends, conduct informal meetings or even host
              small events.
            </p>
            <div className='glow-hours'>
              <h3>Hours of Operation</h3>
        ...
        <div ref={peacockRef} id='horizon-hotel' data-aos='fade-up'>
          <div id='horizon-hotel-words' data-aos='fade-right'>
            ...
            <p>
              ...
              aesthetic and the exotic and vibrant colors of the peacock,
              serving contemporary pan-Asian cuisine. A place that exudes the
              luxurious essence of Glee for relaxed good times, intimate drinks
              and mellow evenings to acoustic jazz music.
            </p>
