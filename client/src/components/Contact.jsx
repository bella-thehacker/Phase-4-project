...
const Contact = () => {
  return (
    <div className="contact-container">
      <header className="w-[50%] h-auto object-contain text-center">
      ...
      <section className="contact-details">
        <div className="contact-info">
          ...
          <h3>Phone</h3>
          <p>+254 (0) 787 654 321</p>
          <h3>Email</h3>
          <p>
            <a href="mailto:sales@hemingways.co">sales@vistaresort.co</a>
          </p>
        </div>
        ...
        <div className="map-container">
          <h2>Find Us Here</h2>
          <iframe
            title="Vista REsort Nairobi Map"
